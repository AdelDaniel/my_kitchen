  ...
  Widget selctionMealsUI() {
    ...
    return Scaffold(
      appBar: CupertinoNavigationBar(
        ...
        middle:  Text('Fillter' , style:Theme.of(context).textTheme.title),
      ),

     drawer: MyDrawer(),
      body: selctionMealsUI()
    );
  }
}
...
//    final Color primaryColor = Color.fromARGB(255, 84, 211, 194);
//   final Color bkgColor = const Color(0xFFFFFFFF);
//   @override
//   Widget build(BuildContext context) {
//         return Container(
//           color: bkgColor,
